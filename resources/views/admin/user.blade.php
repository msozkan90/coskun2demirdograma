        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-4">
                            <a href="{{route('user')}}" class="btn btn-primary btn-block">Yeni Kullanıcılar
                                Ekle</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" enctype="multipart/form-data" action="{{route('user_add')}}" method="POST">
                    @csrf
                    @if ($errors->any())
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{old('name')}}"   name="name" id="name" placeholder="Kullanıcı Adı">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" value="{{old('password')}}"   name="password" id="password" placeholder="Şifre">
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary mr-2 addButton">Ekle</button>
