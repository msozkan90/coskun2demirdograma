    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" enctype="multipart/form-data" action="{{route('image_add')}}" method="POST">
                    @csrf
                    @if ($errors->any())
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" value="{{old('image')}}"  name="image" id="image" placeholder="Projenin resmi ">
                    </div>
