                        ...
                        <div class="row">
                            <div class="col-8 col-sm-12 col-xl-8 my-auto">
                                ...
                                @else
                                    ...
                                    <h6 class="text-muted font-weight-normal">Son ayda 0 yeni proje eklendi</h6>
                                @endif
                            </div>
                            <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                                <i class="icon-lg mdi mdi-wallet-travel text-warning ms-auto"></i>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-8 col-sm-12 col-xl-8 my-auto">
                                ...
                                @else
                                    ...
                                    <h6 class="text-muted font-weight-normal"> Son ayda 0 yeni kullanıcı kayıt oldu</h6>
                                @endif
                            </div>
                            <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                        ...
                        <div class="row">
                            <div class="col-8 col-sm-12 col-xl-8 my-auto">
                                ...
                                @else
                                    ...
                                    <h6 class="text-muted font-weight-normal">Son ayda 0 yeni resim eklendi</h6>
                                @endif
                            </div>
                            <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                        ...
                        <div class="row">
                            <div class="col-8 col-sm-12 col-xl-8 my-auto">
                                ...
                                @else
                                    ...
                                    <h6 class="text-muted font-weight-normal">Son ayda 0 yeni video eklendi</h6>
                                @endif
                            </div>
                            <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                                <i class="icon-lg mdi mdi-video-image text-primary ms-auto"></i>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="badge badge-outline-primary">Video</div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="badge badge-outline-success">Resim</div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="badge badge-outline-warning">Proje</div>
                                    </td>
                                ...
                                @else
                                    <tr>
                                        <td>            <img src="{{asset('project.png')}}" alt="image"  />
                                            <div class="badge badge-outline-warning">Proje</div></td>
                                        <td> -</td>
                                        <td> -</td>
                                        <td>- </td>
                                        <td>- </td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="badge badge-outline-danger">Kullanıcı</div>
                                    </td>
                                    <td> {{$users_last['id']}} </td>
