    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" enctype="multipart/form-data" action="{{route('video_add')}}" method="POST">
                    @csrf
                    @if ($errors->any())
                    ...
                    <div class="form-group">
                        <label for="video">Projenin Videosu</label>
                        <input type="file" class="form-control" value="{{old('video')}}"  name="video" id="video" placeholder="Projenin Videosu ">
                    </div>
